...
import phillyHeatmap from './philly-heatmap.png';
      ...
      <div className="w-full max-w-[900px]">
        <div className="w-full flex flex-col items-center space-y-4">
          <div className="w-full px-4 pt-8 text-center">
            <h2 className="text-xl font-semibold text-blue-600">Base vs. Clearing Price Differential</h2>
            <p className="mt-2 text-sm text-gray-600 max-w-xl mx-auto">
              Hotspots indicate where additional day of sales pricing was needed
            </p>
          </div>
