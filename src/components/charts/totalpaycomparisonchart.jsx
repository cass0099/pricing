...
const data = [
  { length: 0.5, baseTotalPay: 17.5, actualTotalPay: 30.0, routeCount: 10 },
  { length: 1.0, baseTotalPay: 30.0, actualTotalPay: 40.0, routeCount: 15 },
  { length: 1.5, baseTotalPay: 37.5, actualTotalPay: 55.0, routeCount: 19 },
  { length: 2.0, baseTotalPay: 49.0, actualTotalPay: 70.0, routeCount: 22 },
  { length: 2.5, baseTotalPay: 60.0, actualTotalPay: 85.0, routeCount: 30 },
  { length: 3.0, baseTotalPay: 70.5, actualTotalPay: 110.0, routeCount: 79 },
  { length: 3.5, baseTotalPay: 80.5, actualTotalPay: 140.0, routeCount: 51 },
  { length: 4.0, baseTotalPay: 90.0, actualTotalPay: 170.0, routeCount: 31 },
  { length: 4.5, baseTotalPay: 99.0, actualTotalPay: 205.0, routeCount: 18 },
  { length: 5.0, baseTotalPay: 107.5, actualTotalPay: 180.0, routeCount: 7 },
  { length: 5.5, baseTotalPay: 115.5, actualTotalPay: 130.0, routeCount: 12 },
  { length: 6.0, baseTotalPay: 123.0, actualTotalPay: 150.0, routeCount: 29 },
  { length: 6.5, baseTotalPay: 130.0, actualTotalPay: 160.0, routeCount: 16 },
  { length: 7.0, baseTotalPay: 136.5, actualTotalPay: 140.0, routeCount: 14 },
  { length: 7.5, baseTotalPay: 142.5, actualTotalPay: 142.5, routeCount: 11 },
  { length: 8.0, baseTotalPay: 148.0, actualTotalPay: 148.0, routeCount: 8 },
  { length: 8.5, baseTotalPay: 153.0, actualTotalPay: 153.0, routeCount: 2 },
  { length: 9.0, baseTotalPay: 157.5, actualTotalPay: 157.5, routeCount: 0 },
  { length: 9.5, baseTotalPay: 161.5, actualTotalPay: 161.5, routeCount: 0 },
...
const TotalPayComparisonChart = () => {
  ...
  const yAxis = useMemo(() => Array.from({ length: 11 }, (_, i) => i * 25), []);
      ...
      <div className="w-full max-w-[900px]">
        <div className="w-full flex flex-col items-center space-y-4">
          <div className="w-full px-4 pt-8 text-center">
            <h2 className="text-xl font-semibold text-blue-600" >Market-Clearing Prices Defied Existing Assumptions</h2>
            <p className="mt-2 text-sm text-gray-600 max-w-xl mx-auto">
              Sometimes shorter routes needed to be priced higher than longer routes
            </p>
          </div>
...
export default TotalPayComparisonChart;