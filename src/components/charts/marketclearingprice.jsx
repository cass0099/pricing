...
const data = [
  { length: 0.5, basePrice: 35.00, marketPrice: 51.00, routeCount: 10 },
  { length: 1.0, basePrice: 30.00, marketPrice: 46.00, routeCount: 15 },
  { length: 1.5, basePrice: 25.00, marketPrice: 43.00, routeCount: 19 },
  { length: 2.0, basePrice: 24.50, marketPrice: 41.00, routeCount: 22 },
  { length: 2.5, basePrice: 24.00, marketPrice: 46.00, routeCount: 30 },
  { length: 3.0, basePrice: 23.50, marketPrice: 32.00, routeCount: 79 },
  { length: 3.5, basePrice: 23.00, marketPrice: 46.00, routeCount: 51 },
  { length: 4.0, basePrice: 22.50, marketPrice: 43.00, routeCount: 31 },
  { length: 4.5, basePrice: 22.00, marketPrice: 46.00, routeCount: 18 },
  { length: 5.0, basePrice: 21.50, marketPrice: 21.50, routeCount: 7 },
  { length: 5.5, basePrice: 21.00, marketPrice: 21.00, routeCount: 12 },
  { length: 6.0, basePrice: 20.50, marketPrice: 28.00, routeCount: 29 },
  { length: 6.5, basePrice: 20.00, marketPrice: 20.00, routeCount: 16 },
  { length: 7.0, basePrice: 19.50, marketPrice: 19.50, routeCount: 14 },
  { length: 7.5, basePrice: 19.00, marketPrice: 19.00, routeCount: 11 },
  { length: 8.0, basePrice: 18.50, marketPrice: 18.50, routeCount: 8 },
  { length: 8.5, basePrice: 18.00, marketPrice: 18.00, routeCount: 2 },
  { length: 9.0, basePrice: 17.50, marketPrice: 17.50, routeCount: 0 },
  { length: 9.5, basePrice: 17.00, marketPrice: 17.00, routeCount: 0 },
  { length: 10.0, basePrice: 16.50, marketPrice: 16.50, routeCount: 0 }
];
      ...
      <div className="w-full max-w-[900px]">
        <div className="w-full flex flex-col items-center space-y-4">
          <div className="w-full px-4 pt-8 text-center">
            <h2 className="text-xl font-semibold text-blue-600">Market Clearing Price vs. Base Price</h2>
            <p className="mt-2 text-sm text-gray-600 max-w-2xl mx-auto">
              The actual market clearing price includes additional day of sales pricing required to sell all routes
            </p>
          </div>
...
export default MarketClearingChart;