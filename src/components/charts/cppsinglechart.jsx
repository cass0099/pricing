...
const CostPerPackageSingleChart = () => {
  const svgRef = useRef();
        ...
        <div className="w-full flex flex-col items-center space-y-4">
          <div className="w-full px-4 pt-8 text-center">
            <h2 className="text-xl font-semibold text-blue-600">
              Historical Data: Cost Per Package
            </h2>
            <p className="mt-2 text-sm text-gray-600 max-w-xl mx-auto">
              Each data point represents the outcome of a single market day
            </p>
          </div>
...
export default CostPerPackageSingleChart;