...
const data = [
  { length: 0.5, basePrice: 31.0, marketPrice: 37.0, routeCount: 10 },
  { length: 1.0, basePrice: 25.0, marketPrice: 32.0, routeCount: 15 },
  { length: 1.5, basePrice: 23.0, marketPrice: 31.0, routeCount: 20 },
  { length: 2.0, basePrice: 22.5, marketPrice: 32.5, routeCount: 25 },
  { length: 2.5, basePrice: 22.0, marketPrice: 27.0, routeCount: 35 },
  { length: 3.0, basePrice: 21.5, marketPrice: 25.0, routeCount: 20 },
  { length: 3.5, basePrice: 21.0, marketPrice: 30.5, routeCount: 30 },
  { length: 4.0, basePrice: 20.5, marketPrice: 25.0, routeCount: 15 },
  { length: 4.5, basePrice: 20.0, marketPrice: 23.0, routeCount: 25 },
  { length: 5.0, basePrice: 19.5, marketPrice: 21.0, routeCount: 10 },
  { length: 5.5, basePrice: 19.0, marketPrice: 20.0, routeCount: 15 },
  { length: 6.0, basePrice: 18.5, marketPrice: 28.0, routeCount: 30 },
  { length: 6.5, basePrice: 18.0, marketPrice: 22.0, routeCount: 20 },
  { length: 7.0, basePrice: 17.5, marketPrice: 19.0, routeCount: 15 },
  { length: 7.5, basePrice: 17.0, marketPrice: 17.0, routeCount: 10 },
  { length: 8.0, basePrice: 16.5, marketPrice: 16.5, routeCount: 5 },
  { length: 8.5, basePrice: 16.0, marketPrice: 16.0, routeCount: 0 },
  { length: 9.0, basePrice: 15.5, marketPrice: 15.5, routeCount: 0 },
  { length: 9.5, basePrice: 15.0, marketPrice: 15.0, routeCount: 0 },
...
const LowDemandChart = () => {
  ...
  const yAxis = useMemo(() => Array.from({ length: 9 }, (_, i) => i * 5), []);
  const yAxisRight = useMemo(() => Array.from({ length: 5 }, (_, i) => i * 25), []); // 0 to 150 by 30
      ...
      <div className="w-full max-w-[900px]">
        <div className="w-full flex flex-col items-center space-y-4">
          <div className="w-full px-4 pt-8 text-center">
            <h2 className="text-xl font-semibold text-blue-600">Evenly Distributed Route Counts by Duration</h2>
            <p className="mt-2 text-sm text-gray-600 max-w-xl mx-auto">
              More even route count distributions tend to not cause acute supply and demand imbalances
            </p>
          </div>
